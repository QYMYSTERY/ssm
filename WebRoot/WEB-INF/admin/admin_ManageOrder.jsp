        ...
        <div class="row" style="display: flex; flex-direction: column; height: 100%;">
            ...
            <div style="padding: 0 15px; flex: 1;">
            	 <div class="col-sm-8 text-xs-center text-left" style="margin-top: 15px; padding-left: 0;">
                    <a class="btn btn-primary btn-sm" href="${pageContext.request.contextPath}/ManageOrder/PrintingOrder" role="button">打印中</a>
                    <a class="btn btn-primary btn-sm" href="${pageContext.request.contextPath}/ManageOrder/Finished" role="button">已完成</a>
                    <a class="btn btn-primary btn-sm" href="${pageContext.request.contextPath}/ManageOrder/OrderList" role="button">所有</a>
                    ${Msg}
                </div>
                    ...
                    <tbody>
                     <c:forEach items="${listOrder}" var="orderList" >
                        <tr>
                            ...
                            <td>
                            	<a class="btn btn-danger btn-sm" href="${pageContext.request.contextPath}/ManageOrder/updateStatus?orderStatus=${orderList.orderStatus}&orderId=${orderList.id}" role="button">修改状态</a>
                            </td>
                        </tr>
                      </c:forEach>
                    </tbody>
